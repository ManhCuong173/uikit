...
it("renders link correctly", () => {
  const { asFragment } = renderWithTheme(<Link href="https://dmcswap.finance">Link</Link>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz cxXgLd djpNeP"
        color="primary"
        href="https://dmcswap.finance"
      >
        Link
      </a>
    </DocumentFragment>
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithTheme(<LinkExternal href="https://dmcswap.finance">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz cxXgLd djpNeP"
